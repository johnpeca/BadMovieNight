...
for (i  in 1:length(nameList)){
  BadMovies[,ncol(BadMovies)+1] = ifelse(BadMovies$FirstChoice == nameList[i],1,
                                ifelse(BadMovies$SecondChoice == nameList[i],2,
                                ifelse(BadMovies$ThirdChoice == nameList[i],3,4)))
}
